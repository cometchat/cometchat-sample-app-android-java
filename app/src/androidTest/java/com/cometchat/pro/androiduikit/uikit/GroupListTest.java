...
public class GroupListTest {
    ...
    @Test
    public void A_checkGroupListNotEmpty() {
        RecyclerView groupList = (RecyclerView)view.findViewById(R.id.rv_group_list);
        RecyclerView.Adapter adapter = groupList.getAdapter();
        if (adapter.getItemCount()>0) {
            Espresso.onView(Matchers.allOf(
                    withId(R.id.rv_group_list),
    ...
    @Test
    public void A_checkGroupListLastItem() {
        RecyclerView groupList = (RecyclerView)view.findViewById(R.id.rv_group_list);
        RecyclerView.Adapter adapter = groupList.getAdapter();
        if (adapter.getItemCount()>0) {
            Espresso.onView(Matchers.allOf(
