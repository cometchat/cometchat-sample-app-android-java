...
public class StringContract {
    ...
    public static class AppDetails{
        ...
        public static final String APP_ID  =  "XXXXXXXXXXXXXX"; // your app_id
        public static final String API_KEY =  "XXXXXXXXXXXXX"; // your api_key
        public static final String REGION = "XXXXX";  // your app region
