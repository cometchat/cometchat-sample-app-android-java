...
public class LoginActivityPresenter extends Presenter<LoginActivityContract.LoginActivityView> implements
    ...
    public void Login(Context context,String uid) {
        ...
        CometChat.login(uid, StringContract.AppDetails.API_KEY, new CometChat.CallbackListener<User>() {
            ...
            public void onSuccess(User user) {
                ...
                MyFirebaseMessagingService.subscribeUser(user.getUid());
            }
